...
public class AttributeDeferredRegister extends DeferredRegisterWrapper<Attribute> {
   ...
   */
  public DeferredHolder<Object, Attribute> register(String name, double defaultValue, double min, double max, boolean syncable) {
   ...
   * @return  Registered attribute
   */
  public DeferredHolder<Object, Attribute> registerPercent(String name, double defaultValue, boolean syncable) {
   ...
   * @return  Registered attribute
   */
  public DeferredHolder<Object, Attribute> registerMultiplier(String name, boolean syncable) {
