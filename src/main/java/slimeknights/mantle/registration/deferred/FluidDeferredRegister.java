...
public class FluidDeferredRegister extends DeferredRegisterWrapper<Fluid> {
   ...
   */
  public <I extends FluidType> DeferredHolder<Object, I> registerType(String name, Supplier<? extends I> sup) {
   ...
   * @return  Fluid to supply
   */
  public <I extends Fluid> DeferredHolder<Object, I> registerFluid(String name, Supplier<? extends I> sup) {
  ...
  public class Builder extends FluidBuilder<Builder> {
    ...
    public <F extends Fluid> FluidObject<F> unplacable(Function<FluidBuilder<?>,F> constructor) {
      ...
      DeferredHolder<Object, F> fluid = registerFluid(name, () -> constructor.apply(this));
