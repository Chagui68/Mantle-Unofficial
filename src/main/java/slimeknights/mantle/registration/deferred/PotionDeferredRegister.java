...
public class PotionDeferredRegister extends DeferredRegisterWrapper<Potion> {
  ...
  public DeferredHolder<Object, Potion> register(String name, Supplier<Potion> potion) {
  ...
  /** Registers a group of potions with the same effect */
  public Builder registerTypes(DeferredHolder<Object, ? extends MobEffect> effect, int duration, int amplifier) {
  ...
  public Builder registerTypes(DeferredHolder<Object, ? extends MobEffect> effect) {
